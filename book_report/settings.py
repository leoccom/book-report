...
SECRET_KEY = 'django-insecure-+hrv0qq07utipvzfbfy8y1z06&*260c_ahz(fxo3(^8^2eu21-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['book-report-dcdd1da453f0.herokuapp.com',]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'book_report', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
